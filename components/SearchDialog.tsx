    ...
    <>
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] max-h-[80vh] overflow-y-auto text-black">
          <DialogHeader>
            <DialogTitle>WellnessAI</DialogTitle>
            <DialogDescription>
            Your personal guide to health and wellness
            </DialogDescription>
            <hr />
            ...
            <div className="grid gap-4 py-4 text-slate-700">
              ...
              {error && (
                <div className="flex items-center gap-4">
                  ...
                  Oops! looks like I need a doctor now. (Don&apos;t worry, it&apos;s not you!)
                  {/* Oops! Looks like we&apos;ve hit a vitamin deficiency in our response */}
                  </span>
                </div>
              )}
              ...
              <div className="text-xs text-gray-500 dark:text-gray-100">
                ...
                <button
                  ...
                  transition-colors"
                  onClick={(_) => setQuery('I feel headache')}
                >
                  I feel headache
                </button>
              </div>
